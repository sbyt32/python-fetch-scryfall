...
# import scripts.connect.to_requests_wrapper as to_req
# def fetch_tcg_data(tcg_id:str):
...
for card in res:
    ...
    payload = "{listingType:'All',offset:0,limit:25,time:1668972898655}"
    headers = {
